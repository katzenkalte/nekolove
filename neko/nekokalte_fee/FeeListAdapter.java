...
public class FeeListAdapter extends ArrayAdapter<FeeListItem1> {

	private List<FeeListItem1> items2;
	private int magic;

	// コンストラクタ
	public FeeListAdapter(Context context, List<FeeListItem1> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		FeeListItem1 item2 = items2.get(position);
...
//			magicは使用していないので下記に修正
		...
		textView1.setText(""+item2.monthOfYear);
